...
export default function Pricing() {
 ...
 <ul className="list-outside space-y-3 text-sm">
 {['Everything in Free Plan', '5TB Cloud Storage', 'Priority Email and Chat Support', 'Access to Community Forum', 'Single User Access'].map((item, index) => (
 <li
 key={index}
 className="flex items-center gap-2">
 <Check className="size-3" />
 ...
 <ul className="list-outside space-y-3 text-sm">
 {['Everything in Pro Plan', 'Unlimited Cloud Storage', '24/7 Phone Support', 'Advanced Security Features', 'Custom Integrations', 'Dedicated Account Manager'].map((item, index) => (
 <li
 key={index}
 className="flex items-center gap-2">
 <Check className="size-3" />
